  ...
  return (
    <div>
      ...
      <motion.div 
        ...
        className="text-left md:text-center md:px-6 lg:px-[174px] mb-20 bg-gray-50 dark:bg-gray-800 py-36 mt-20"
      >
        <p className="text-[18px] dark:text-gray-200 uppercase my-4">Our Story</p>
        <h1 className="text-4xl lg:text-[60px] font-customFont leading-[1] tracking-tight text-gray-900 dark:text-gray-100 mb-10 lg:px-20">
          Showcasing the Real People and Authentic Vision Behind Our Design Philosophy
        </h1>
        <p className="text-lg text-gray-600 dark:text-gray-200 mb-8 px-10">
      ...
      <motion.div 
        ...
        transition={{ duration: 0.8 }}
        className="w-screen mb-10 mx-5 lg:px-48 flex flex-col md:flex-row justify-center items-center gap-8"
      >
      ...
      >
        <div className="flex flex-col dark:text-gray-200 lg:items-center mx-5 gap-4 text-left lg:text-center lg:px-[174px] mt-5">
        ...
        {/* Buttons */}
        <div className="flex flex-col sm:justify-center sm:items-center mx-5 mt-10 sm:flex-row gap-4">
