...
export default function About() {
  return (
    <div className="py-12 mt-20 md:px-6 lg:px-24 ">
      ...
      <div className="max-w-5xl mb-10 mx-5 flex flex-col md:flex-row items-center gap-8">
      ...
      <div className="flex flex-col dark:text-gray-200 lg:items-center mx-5 gap-4 text-left lg:text-center lg:px-[150px] mt-5">
