...
function ChooseUs() {
  return (
    <div>
      ...
      <div className="text-black py-12 mt-10 flex flex-col justify-center gap-5 items-center text-center lg:text-left md:px-10 pb-20 md:pt-10 lg:flex-row lg:gap-[150px]">
        <div className="">
        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-6 text-left">
          <div className="p-6 bg-gray-50 dark:bg-gray-800 border rounded-2xl">
