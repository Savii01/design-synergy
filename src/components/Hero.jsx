    ...
    <div className="w-screen h-screen flex justify-center items-center px-4 bg-white dark:bg-gray-900">
      <div className="flex flex-col gap-6 items-start md:items-center text-center max-w-4xl px-4 md:px-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <Link to='/' className="text-white w-[300px] h-[50px] md:w-[200px] text-[16px] sm:text-[20px] bg-purple dark:bg-lightBlue dark:text-black dark:hover:text-white font-bold py-2 px-6 sm:px-8 rounded-lg hover:bg-gradient-purple-blue transition-all">
            Hire Us
          </Link>
